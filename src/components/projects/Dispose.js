import heroLarge from '../../img/dispose/dispose_01.jpg';
import heroSmall from '../../img/dispose/dispose_01-small.jpg';
import videoMp4 from '../../img/dispose/dispose_website.mp4';
import videoWebm from '../../img/dispose/dispose_website.webm';
import { importAll } from '../../functions.js';

const Dispose = () => {
  // import large images
  var imagesLarge = importAll(require.context('../../img/dispose/large', true, /\.(png|jpe?g|svg)$/));
  // import small images
  var imagesSmall = importAll(require.context('../../img/dispose/small', true, /\.(png|jpe?g|svg)$/));
