...
const CreateBuildDestroy = () => {
  // import small images
  var imagesSmall = importAll(require.context('../../media/createbuilddestroy/small', true, /\.(png|jpe?g|svg|gif)$/));
  ...
  return (
    ...
    <p className="text-block"><a href="https://createbuilddestroy.com" target="_blank" rel="noreferrer">createbuilddestroy.com</a></p>
